...
def fire_bullet(x,y):
	global bullet_state
	bullet_state="fire"
	screen.blit(bulletImg,(x+16,y+10)) #to make the bullet appear to fire from the centre of the spaceship
...
#checking for boundaries, so that it does not goes out of bound
